...
<p> Predict <b> Tip Amount </b> from <b> Total Bill </b> using Regularization</p>
</div>
...
alpha = st.slider("Regularization Strength (Alpha)", 0.01, 5.0, 1.0)
...
# --------------------------------------------------
# Train Model
if model_type == "Ridge Regression (L2)":
